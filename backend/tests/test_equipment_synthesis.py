...
class EquipmentSynthesisTests(unittest.TestCase):
    ...
    def test_disassemble_equipment_gives_material(self):
        ...
        success, msg = player.disassemble_equipment(equip.instance_id)
    ...
    def test_limit_break_fails_without_material_and_keeps_item(self):
        ...
        ok, msg = player.limit_break_equipment(BRONZE_SWORD.equip_id)
        self.assertFalse(ok)
        self.assertIsInstance(msg, str)
    ...
    def test_limit_break_persists(self):
        ...
        ok, _ = player.limit_break_equipment(equip.instance_id)
        self.assertTrue(ok)
