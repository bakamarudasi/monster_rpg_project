...
|---|---|---|---|---|---|
| S | 水 | aquatic | `abyssal_tide_king.png` | 深淵の海皇レヴィオス | 深海の闇に君臨する海の皇帝。渦潮は艦隊すら呑み込む。 |
| S | 闇 | aquatic | `void_leviathan.png` | 虚海のリヴァイアサン | 光の届かぬ深海を統べる虚無の巨鯨。波濤ごと正気を呑む。 |
| S | 光 | beast | `celestial_panther.png` | セレスティアルパンサー | 天空の力を帯びし神秘の黒豹。星降る夜、その姿を見ること叶う。 |
| S | 土 | construct | `gaia_colossus.png` | 山喰らいの巨王ガイオス | 山脈そのものが起き上がったかのような巨王。一歩ごとに大地が割れる。 |
| S | 毒 | demon | `plague_monarch.png` | 万病の魔王ペスティス | あらゆる病と腐敗を統べる魔王。触れるものすべてを朽ち果てさせる。 |
| S | 風 | elemental | `storm_sovereign.png` | 暴風の覇王アエロス | 空の覇権を握る暴風の化身。その翼の一振りが嵐を呼ぶ。 |
| S | 雷 | elemental | `thunder_emperor.png` | 雷霆の帝王ヴォルガ | 天空に玉座を構える雷の帝王。神鳴を意のままに操り、大地を焼く。 |
| S | 氷 | humanoid | `glacial_empress.png` | 氷獄の女王 | 永久凍土を統べる女王。触れるものすべてを静かな氷像へ変える。 |
| S | 闇 | spirit | `abyssal_seraph.png` | 堕天の熾天使 | 光輪を黒く染め、闇へ堕ちた熾天使。慈悲の代わりに終焉を配る。 |
| S | 光 | spirit | `astral_seraphim.png` | 天輪のセラフィム | 幾重もの光輪を巡らせる熾天使。裁きと癒やしを同時に下す。 |
| A | 光 | beast | `solar_griffon.png` | 陽光のグリフォン | 陽光を纏う気高き獅鷲。その翼は希望の旗印とされる。 |
| A | 雷 | beast | `thunderlord_roc.png` | 雷帝の大鷲 | 嵐を従える雷の大鷲。疾風のハリアーが極まった姿。 |
| A | 闇 | construct | `obsidian_gargoyle.png` | 黒曜のガーゴイル | 黒曜石の翼を畳む夜の番獣。昼は像、夜に牙を剥く。 |
